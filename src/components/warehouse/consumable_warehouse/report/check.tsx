...
const ProductCheck: React.FC = () => {
    ...
    const fetchData = async () => {
        await axios.get(
            `${Url}/api/product_check/${context.currentProductCheck}/`, {
                headers: {
        ...
        <>
            <Space.Compact style={{marginBottom: 16}}>
                ...
                <Button type={"primary"} htmlType={"button"} onClick={() => {
                    ...
                    fetch(Check?.checks as string).then(response => {
                        response.blob().then(() => {
                            let alink = document.createElement('a');
                            alink.href = Check?.checks as string;
                            alink.download = `${Check?.code}.jpg`
                            alink.click();
                        })
                    })
            ...
            <Table
                ...
                dataSource={Check?.jsonData}/>
            {Check !== undefined ?
                <TableCheckPrint componentPDF={componentPDF} Check={Check}/>
                :
                null
            }
        </>
