...
const ConsumeProductForm: React.FC = () => {
    ...
    const onFinish = async () => {
        new Promise(resolve => resolve(
            ...
            async () => {
                await axios.post(
                    `${Url}/api/consuming_material_factor/`, {
                                                ...
                                                <Select placeholder="انتخاب کنید"
                                                        ...
                                                        onChange={() => {
                                                            form.getFieldValue(['products']).map(async (product: {
                                                                ...
                                                                await axios.get(`${Url}/api/consuming_material/?code=${product.product}`, {
                                                                    headers: {
                                                                        'Authorization': 'Bearer ' + localStorage.getItem('access_token'),
                                                                    }
                                                                }).then(response => {
...
export default ConsumeProductForm;