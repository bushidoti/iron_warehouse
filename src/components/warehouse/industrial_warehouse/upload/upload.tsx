...
export const UploadIndustrialWareHouse = () => {
    ...
    const fetchData = async () => {
        setLoading(true)
        await axios.get(`${Url}/api/${selectedDoc === 'مواد اولیه' ? 'raw_material_factor' : 'consuming_material_factor' }`, {
            headers: {
    ...
    useEffect(() => {
        ...
        const onFinish = async () => {
            setLoading(true)
            if (selectedDoc === 'مواد اولیه'){
               await axios.put(`${Url}/api/raw_material_factor/${selectedDocSub}/`, {
            ...
            }else  if (selectedDoc === 'مواد مصرفی'){
               await axios.put(`${Url}/api/consuming_material_factor/${selectedDocSub}/`, {
                    factor: context.compressed,
                }, {
                    headers: {
                        'Authorization': 'Bearer ' + localStorage.getItem('access_token'),
    ...
    return (
        <>
            <Space.Compact>
                <Select placeholder="فاکتور مربوط به انبار"
