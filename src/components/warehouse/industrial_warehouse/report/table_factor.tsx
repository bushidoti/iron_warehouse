        ...
        <div style={{display: 'none'}}>
            <table
                ...
                <tr>
                    ...
                    <tr>
                        <th colSpan={3} className='text-[10px] p-2 font-extrabold'>نام طرف حساب : {props.Factor.jsonData[0]?.seller}</th>
                        <th colSpan={1} className='text-[10px] p-2 font-extrabold'>شماره فاکتور : {props.Factor.jsonData[0]?.document_code}</th>
                    </tr>
                    <tr>
                            ...
                            <Flex>
                               ...
                               <div className="w-[150px] ps-1 border-solid border text-center">
                                ...
                                <div className="w-[203px] ps-1 border-solid border text-center">
                                   <Text className='text-[12px]' strong>
                                    {`${props.Factor.jsonData.reduce((a, v) => a + (v.rate * v.input), 0)}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                                   </Text>
                               </div>
                            </Flex>
                       </td>
