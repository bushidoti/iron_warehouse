...
import qs from "qs";
import TablePrint from "../ptrint_table/table_print_facility";
...
const FacilityFurnitureTable: React.FC = () => {
    ...
    const columns: ColumnsType<DataType> = [
        {
            ...
            render: (_value, record) => <Button disabled={record.movement_status === 'ارسال شده'} type={"link"} onClick={() => {
                ...
                navigate(`/warhouse/property/facility-furniture/edit/${record.code}`)
             }}>{record.code}</Button>,
        }, {
            align: "center",
            title: 'نام اموال',
...
export default FacilityFurnitureTable;