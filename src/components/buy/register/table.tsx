                ...
                <tr>
                        ...
                        <th colSpan={1} className="ps-4 border-solid border text-right">
                               <Space size={10} direction="vertical">
                                     ...
                                     <Text className='text-[12px] font-extrabold'> شماره: {props.autoIncrement} </Text>
                                     <Text className='text-[12px] font-extrabold'>تاریخ : {dayjs().locale('fa').format('DD-MM-YYYY')}</Text>
                               </Space>
                        </th>
                    </tr>
                    <tr>
                        <th colSpan={7} className='text-[12px] border border-solid p-2 text-right font-extrabold'>خواهشمند است اقلام مشروحه زیل را جهت {props.productSub[0]?.purpose} تحویل فرمایید</th>
                    </tr>
                </thead>
                <thead>
                    <tr>
