                ...
                <tr>
                  ...
                  <tr>
                   ...
                   <tr>
                      ...
                      <tr>
                            <th colSpan={2} className='text-[10px] text-right  font-extrabold'>نام خریدار : {props.productSub[0]?.buyer}</th>
                      ...
                      <tr>
                            <th colSpan={2} className='text-[10px] text-right font-extrabold'>شناسه ملی : {props.productSub[0]?.buyer_national_id}</th>
                      ...
                      <tr>
                            <th colSpan={4} className='text-[10px] text-right font-extrabold'>نشانی : {props.productSub[0]?.address_buyer} </th>
                            <th colSpan={3} className='text-[10px] text-right font-extrabold'>تلفن : {props.productSub[0]?.phone_buyer}</th>
                       </tr>
                    <tr>
                        <th colSpan={7} className='border-solid border text-center font-extrabold'>
                              <Text className='text-[10px]' strong>
                        ...
                        <td colSpan={7}>
                            <Flex>
                               ...
                               <div className="w-[150px] ps-1 border-solid border text-center">
                                ...
                                <div className="w-[203px] ps-1 border-solid border text-center">
                                   <Text className='text-[12px]' strong>
                                    {`${props.productSub[0]?.extra ? props.productSub[0]?.extra : 0 }`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                                   </Text>
                               </div>
                            </Flex>
                            <Flex>
                            ...
                            <Flex>
                               ...
                               <div className="w-[150px] ps-1 border-solid border text-center">
                                ...
                                <div className="w-[203px] ps-1 border-solid border text-center">
                                   <Text className='text-[12px]' strong>
                                    {`${props.productSub[0]?.totalFactor}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                                   </Text>
                                </div>
                            </Flex>
                            <Flex>
                               ...
                               <div className="w-[150px] ps-1 border-solid border text-center">
                                ...
                                <div className="w-[203px] ps-1 border-solid border text-center">
                                   <Text className='text-[12px]' strong>
                                    {`${props.productSub[0]?.paid}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                                   </Text>
                               </div>
                            </Flex>
                       </td>
                    ...
                    <tr>
                      <td colSpan={7}>
                          <Flex>
                             ...
                             <div className="w-1/2 ps-1 border-solid border grid grid-cols-2">
                                  <div className="col-start-1 col-span-4"><Text className='text-[10px]'>نام خریدار: {props.productSub[0]?.buyer}</Text></div>
                                  <div className="col-start-1 col-span-4"></div>
                                  <div className="col-end-3 ms-10"><Text className='text-[10px]'>امضاء</Text></div>
                             </div>
                          </Flex>
