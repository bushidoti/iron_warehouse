        ...
        <div style={{display: 'none'}}>
            <table
                ...
                <tr>
                    ...
                    <tr>
                        <th colSpan={6} className='text-[12px] border border-solid p-2 text-right font-extrabold'>خواهشمند است اقلام مشروحه زیل را جهت {props.productSub.filter((product: { id: number; }) => product.id === props.filterable)[0]?.purpose} تحویل فرمایید</th>
                    </tr>
                </thead>
                <thead>
                    <tr>
                      ...
                      <td colSpan={7}>
                          <Flex>
                             <div className="w-1/3 ps-1 border-solid border grid grid-cols-2">
                                  <div className="col-start-1 col-span-4"><Text className='text-[10px]'>درخواست کننده(تولید) : {props.productSub.filter((product: { id: number; }) => product.id === props.filterable)[0]?.applicant}</Text></div>
