        ...
        <div style={{display: 'none'}}>
            <table
                ...
                <tr>
                    ...
                    <tr>
                        <th colSpan={6} className='text-[12px] border border-solid p-2 text-right font-extrabold'>خواهشمند است اقلام مشروحه زیل را جهت {props.productSub.filter((product: { id: number; }) => product.id === props.filterable)[0]?.purpose} به تعداد {props.productSub.filter((product: { id: number; }) => product.id === props.filterable)[0]?.amount}  عدد تحویل فرمایید</th>
                    </tr>
                </thead>
                <thead>
                    <tr>
